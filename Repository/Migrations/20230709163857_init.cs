        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ECinemaUserId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Orders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Orders_AspNetUsers_ECinemaUserId",
                        column: x => x.ECinemaUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShoppingCarts_AspNetUsers_ECinemaUserId",
                        column: x => x.ECinemaUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketsInShoppingCart", x => new { x.ShoppingCartId, x.TicketId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_ECinemaUserId",
                table: "Orders",
                column: "ECinemaUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCarts_ECinemaUserId",
                table: "ShoppingCarts",
                column: "ECinemaUserId",
                unique: true,
                filter: "[ECinemaUserId] IS NOT NULL");
